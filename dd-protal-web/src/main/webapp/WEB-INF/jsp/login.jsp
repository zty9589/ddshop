...
<div class="w">
	<div id="logo">
		<a href="index.html">
			<img src="images/shortcut/search_logo.png" alt="">
		</a>
		<b></b>
	</div>
	<!-- 左边登录logo结束 -->
...
<div id="content">
	...
	<div class="login-wrap">
					...
					<div class="mc">
						...
						<div class="qrcode-main">
							...
							<div class="qrcode-img" style="">
								<img src="images/nav/code.png" alt="">
		...
		<!-- w结束 -->
		<!-- 中间广告部分开始 -->
		<div class="login-banner" style="background: url(images/nav/a1.png);>
  		<div class="w">
