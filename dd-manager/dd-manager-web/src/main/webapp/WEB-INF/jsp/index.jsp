...
<div data-options="region:'west'" style="width:200px;">
    <div id="menu" class="easyui-accordion">
        ...
        <div title="会员管理" data-options="selected:true,iconCls:'icon-tip'" style="padding:10px 0;">
            <ul class="easyui-tree">
                <li data-options="attributes:{'href':'item-add'}">会员列表</li>
                <li data-options="attributes:{'href':'item-list'}">黑名单列表</li>
            </ul>
        </div>
        <div title="订单管理" data-options="selected:true,iconCls:'icon-tip'" style="padding:10px 0;">
            <ul class="easyui-tree">
                <li data-options="attributes:{'href':'item-add'}">订单列表</li>
                <li data-options="attributes:{'href':'item-list'}">已付款订单</li>
                <li data-options="attributes:{'href':'item-param-list'}">待付款订单</li>
                <li data-options="attributes:{'href':'item-param-list'}">已完结订单</li>
            </ul>
        </div>
...
<div data-options="region:'center'" style="background:#eee;">
    <div id="tab" class="easyui-tabs" data-options="fit:true">
        <div title="欢迎页面" style="padding:40px;">当当欢迎您</div>
    </div>
</div>
<!-- jquery -->
